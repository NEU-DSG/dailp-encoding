  ...
  config.data.aws_iam_policy_document = {
    basic_user_policy = {
      statement = {
        ...
        principals = {
          type = "AWS";
          identifiers = [ "$\{config.resource.aws_iam_role.basic_user_role.arn}" ];
        };
      };
    };
    ...
    contributor_user_policy = {
      statement = {
        ...
        principals = {
          type = "AWS";
          identifiers = [ "$\{config.resource.aws_iam_role.contributor_user_role.arn}" ];
        };
      };
    };
    ...
    editor_user_policy = {
      statement = {
        ...
        principals = {
          type = "AWS";
          identifiers = [ "$\{config.resource.aws_iam_role.editor_user_role.arn}" ];
        };
      };
    };
  };
