...
export type IndexPageQuery = { dailp: { allDocuments: Array<Pick<Dailp_AnnotatedDoc, 'id' | 'title' | 'collection'>> } };
...
export type AnnotatedDocumentQuery = { dailp: { document?: Maybe<(
      Pick<Dailp_AnnotatedDoc, 'id' | 'title' | 'collection'>
      & { translatedSegments?: Maybe<Array<{ source: BlockFieldsFragment | FormFieldsFragment, translation: Pick<Dailp_Block, 'segments'> }>> }
    )> } };
...
export type CollectionQuery = { dailp: { allDocuments: Array<Pick<Dailp_AnnotatedDoc, 'id' | 'title'>> } };
