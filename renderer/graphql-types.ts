...
export type Dailp_AnnotatedSeg =
...
export type Dailp_BlockType = "BLOCK" | "PHRASE"

export type Dailp_DocumentType = "REFERENCE" | "CORPUS"
...
export type IndexPageQuery = {
  dailp: {
    allDocuments: Array<Pick<Dailp_AnnotatedDoc, "id" | "title" | "collection">>
  }
}
  ...
  dailp: {
    document?: Maybe<
      Pick<Dailp_AnnotatedDoc, "id" | "title" | "collection"> & {
        translatedSegments?: Maybe<
          Array<{
            source: BlockFieldsFragment | FormFieldsFragment
            translation: Pick<Dailp_Block, "segments">
          }>
        >
      }
    >
...
export type BlockFieldsFragment = Pick<
  Dailp_AnnotatedPhrase,
  "ty" | "index"
> & { parts: Array<FormFieldsFragment> }

export type FormFieldsFragment = Pick<
  Dailp_AnnotatedForm,
  "index" | "source" | "simplePhonetics" | "phonemic" | "englishGloss"
...
export type CollectionQuery = {
  dailp: { allDocuments: Array<Pick<Dailp_AnnotatedDoc, "id" | "title">> }
}
