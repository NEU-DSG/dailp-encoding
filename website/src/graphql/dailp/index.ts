...
export type AnnotatedSeg = AnnotatedForm | AnnotatedPhrase | LineBreak | PageBreak;
...
export type CollectionsListingQuery = { __typename?: 'Query', allCollections: Array<{ __typename?: 'DocumentCollection', name: string, slug: string }> };

export type DocumentsPagesQueryVariables = Exact<{ [key: string]: never; }>;


export type DocumentsPagesQuery = { __typename?: 'Query', allDocuments: Array<{ __typename?: 'AnnotatedDoc', id: string, slug: string, isReference: boolean }> };
...
export type CollectionQuery = { __typename?: 'Query', collection: { __typename?: 'DocumentCollection', name: string, documents: Array<{ __typename?: 'AnnotatedDoc', id: string, slug: string, title: string, orderIndex: number, date: { __typename?: 'Date', year: number } | null | undefined }> } };
...
export type WordSearchQuery = { __typename?: 'Query', wordSearch: Array<{ __typename?: 'AnnotatedForm', source: string, normalizedSource: string | null | undefined, simplePhonetics: string | null | undefined, documentId: string, englishGloss: Array<string> }> };

export type AllSourcesQueryVariables = Exact<{ [key: string]: never; }>;


export type AllSourcesQuery = { __typename?: 'Query', allDocuments: Array<{ __typename?: 'AnnotatedDoc', isReference: boolean, id: string, title: string, formCount: number, date: { __typename?: 'Date', year: number } | null | undefined, contributors: Array<{ __typename?: 'Contributor', name: string }> }> };

export type GlossaryQueryVariables = Exact<{ [key: string]: never; }>;


export type GlossaryQuery = { __typename?: 'Query', allTags: Array<{ __typename?: 'MorphemeTag', id: string, morphemeType: string, crg: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined, taoc: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined, learner: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined }> };
...
export type TimelineQuery = { __typename?: 'Query', morphemeTimeClusters: Array<{ __typename?: 'FormsInTime', start: { __typename?: 'Date', year: number } | null | undefined, end: { __typename?: 'Date', year: number } | null | undefined, forms: Array<{ __typename?: 'AnnotatedForm', source: string, normalizedSource: string | null | undefined, simplePhonetics: string | null | undefined, phonemic: string | null | undefined, documentId: string, englishGloss: Array<string> }> }> };
...
export type DocumentDetailsQuery = { __typename?: 'Query', document: { __typename?: 'AnnotatedDoc', id: string, slug: string, title: string, collection: { __typename?: 'DocumentCollection', name: string, slug: string } | null | undefined, date: { __typename?: 'Date', year: number } | null | undefined, contributors: Array<{ __typename?: 'Contributor', name: string, role: string }>, sources: Array<{ __typename?: 'SourceAttribution', name: string, link: string }> } | null | undefined };
...
export type EditablePageQuery = { __typename?: 'Query', page: { __typename?: 'Page', id: string, title: string, body: Array<{ __typename: 'Gallery' } | { __typename: 'Markdown', content: string }> } | null | undefined };
...
export type TagQuery = { __typename?: 'Query', tag: { __typename?: 'MorphemeTag', id: string, morphemeType: string, taoc: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined, crg: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined, learner: { __typename?: 'TagForm', tag: string, title: string, definition: string } | null | undefined } | null | undefined };
...
export type MorphemeQuery = { __typename?: 'Query', documents: Array<{ __typename?: 'WordsInDocument', documentId: string | null | undefined, documentType: DocumentType | null | undefined, forms: Array<{ __typename?: 'AnnotatedForm', index: number, source: string, normalizedSource: string | null | undefined, documentId: string, englishGloss: Array<string> }> }> };
...
export function useCollectionsListingQuery(options: Omit<Urql.UseQueryArgs<CollectionsListingQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<CollectionsListingQuery>({ query: CollectionsListingDocument, ...options });
};
...
export function useDocumentsPagesQuery(options: Omit<Urql.UseQueryArgs<DocumentsPagesQueryVariables>, 'query'> = {}) {
...
export const WordSearchDocument = gql`
  ...
  wordSearch(
    queries: [{source: $query}, {normalizedSource: $query}, {simplePhonetics: $query}, {englishGloss: $query}]
  ) {
    source
    normalizedSource
    simplePhonetics
...
export function useWordSearchQuery(options: Omit<Urql.UseQueryArgs<WordSearchQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<WordSearchQuery>({ query: WordSearchDocument, ...options });
};
...
export function useAllSourcesQuery(options: Omit<Urql.UseQueryArgs<AllSourcesQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<AllSourcesQuery>({ query: AllSourcesDocument, ...options });
};
...
export function useGlossaryQuery(options: Omit<Urql.UseQueryArgs<GlossaryQueryVariables>, 'query'> = {}) {
...
export function useDocumentDetailsQuery(options: Omit<Urql.UseQueryArgs<DocumentDetailsQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<DocumentDetailsQuery>({ query: DocumentDetailsDocument, ...options });
};
...
export function useEditablePageQuery(options: Omit<Urql.UseQueryArgs<EditablePageQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<EditablePageQuery>({ query: EditablePageDocument, ...options });
};
...
export function useMorphemeQuery(options: Omit<Urql.UseQueryArgs<MorphemeQueryVariables>, 'query'> = {}) {
...
export function useNewPageMutation() {
  return Urql.useMutation<NewPageMutation, NewPageMutationVariables>(NewPageDocument);
};