...
declare namespace GatsbyTypes {
  ...
  type Query_wpMediaItemArgs = {
    ...
    ancestors: Maybe<
      WpHierarchicalContentNodeToContentNodeAncestorsConnectionFilterInput
    >
    ...
    wpChildren: Maybe<
      WpHierarchicalContentNodeToContentNodeChildrenConnectionFilterInput
    >
    ...
    modifiedGmt: Maybe<DateQueryOperatorInput>
    wpParent: Maybe<
      WpHierarchicalContentNodeToParentContentNodeConnectionEdgeFilterInput
    >
  ...
  type Query_wpPageArgs = {
    ...
    enclosure: Maybe<StringQueryOperatorInput>
    featuredImage: Maybe<
      WpNodeWithFeaturedImageToMediaItemConnectionEdgeFilterInput
    >
  ...
  enum SitePluginFieldsEnum {
    ...
    pluginOptions___debug___graphql___writeQueriesToDisk = "pluginOptions.debug.graphql.writeQueriesToDisk",
  ...
  type SitePluginPluginOptions = {
    ...
    readonly debug: Maybe<SitePluginPluginOptionsDebug>
    readonly typeName: Maybe<Scalars["String"]>
    readonly fieldName: Maybe<Scalars["String"]>
  ...
  type SitePluginPluginOptionsDebug = {
    readonly graphql: Maybe<SitePluginPluginOptionsDebugGraphql>
  }

  type SitePluginPluginOptionsDebugFilterInput = {
    readonly graphql: Maybe<SitePluginPluginOptionsDebugGraphqlFilterInput>
  }

  type SitePluginPluginOptionsDebugGraphql = {
    readonly writeQueriesToDisk: Maybe<Scalars["Boolean"]>
  }

  type SitePluginPluginOptionsDebugGraphqlFilterInput = {
    readonly writeQueriesToDisk: Maybe<BooleanQueryOperatorInput>
  }
  ...
  type SitePluginPluginOptionsFilterInput = {
    ...
    readonly debug: Maybe<SitePluginPluginOptionsDebugFilterInput>
    readonly typeName: Maybe<StringQueryOperatorInput>
    readonly fieldName: Maybe<StringQueryOperatorInput>
    ...
    readonly segments: Maybe<
      ReadonlyArray<
        Pick<
          ...
          "morpheme" | "gloss" | "displayGloss" | "nextSeparator"
        > & { simpleMorpheme: Dailp_MorphemeSegment["morpheme"] } & {
          readonly matchingTag: Maybe<
            Pick<Dailp_MorphemeTag, "crg" | "learner">
          >
        }
      >
    >
  ...
  type BlockFieldsFragment = Pick<Dailp_AnnotatedPhrase, "ty" | "index"> & {
    readonly parts: ReadonlyArray<
      | { readonly __typename: "Dailp_AnnotatedPhrase" }
      | ({ readonly __typename: "Dailp_AnnotatedForm" } & FormFieldsFragment)
          ...
          readonly translatedSegments: Maybe<
            ReadonlyArray<{
              readonly source:
                ...
                | { readonly __typename: "Dailp_LineBreak" }
                | ({ readonly __typename: "Dailp_PageBreak" } & Pick<
                    Dailp_PageBreak,
                    "index"
                  >)
      ...
      readonly document: Maybe<
        Pick<Dailp_AnnotatedDoc, "id" | "slug" | "title"> & {
          ...
          readonly people: ReadonlyArray<
            Pick<Dailp_PersonAssociation, "name" | "role">
          >
        }
      >
    }
