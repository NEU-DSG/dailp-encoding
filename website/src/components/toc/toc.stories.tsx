...
const meta: Meta<typeof CollectionTOC> = {
  title: "Components/CollectionTOC",
  component: CollectionTOC,
...
export const DefaultWithWhiteText: Story = {}
