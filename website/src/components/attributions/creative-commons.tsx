...
const CcIcon = () => {
    return(
        <img className={ css.ccIcon } src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1"/>
    )
}

const ByIcon = () => {
    return(
        <img className={ css.ccIcon } src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1"/>
    )
}

const NcIcon = () => {
    return(
        <img className={ css.ccIcon } src="https://mirrors.creativecommons.org/presskit/icons/nc.svg?ref=chooser-v1"/>
    )
}