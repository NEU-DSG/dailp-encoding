...
export const HomepageHeader = (props: {
  ...
  const subtitleText = props.subtitle || "Digital Archive of Indigenous Language Persistence"

  return (
    <div className={styles.headerContainer}>
      <img src={imageSrc} className={styles.headerImage} alt="Header background" />
      ...
      <div className={styles.overlay}>
        ...
        <div className={styles.buttonGroup}>
          <Button as="a" href={props.button_left.link} className={styles.actionButton}>
            {props.button_left.text}
          </Button>
          <Button as="a" href={props.button_right.link} className={styles.actionButton}>
