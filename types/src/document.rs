...
mod tests {
    use super::*;
    use crate::{
        auth::UserInfo, comment::Comment, date::DateInput, slugify, AnnotatedForm, AudioSlice, Contributor, Database, Date, DocumentId, DocumentShortName, SourceAttribution, Translation, TranslationBlock
    };
    
    use async_graphql::{dataloader::{DataLoader, Loader}, FieldResult, MaybeUndefined};
    use serde::{Deserialize, Serialize};
    use sqlx::{PgPool, Row, Pool, Transaction, Postgres};
    use uuid::Uuid;
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_name_empty_name(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        let db = Database::with_pool(pool);
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_name_nonexistent_document(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        let db = Database::with_pool(pool);
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_name_case_sensitivity(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        // Create dummy document_group
        let group_id = sqlx::query!(
            "INSERT INTO document_group (slug, title) VALUES ($1, $2) RETURNING id",
            "Test Group Slug",
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_name_multiple_documents(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_id_with_empty_keys(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        let db = Database::with_pool(pool);
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_id_nonexistent_document(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_id_multiple_documents(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        // Create a document group
        let group_id = sqlx::query!(
            "INSERT INTO document_group (slug, title) VALUES ($1, $2) RETURNING id",
            "Test Group",
    ...
    #[sqlx::test(migrations = "./migrations")]
    async fn test_get_document_by_id_duplicate_keys(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
        // Create a document group
        let group_id = sqlx::query!(
            "INSERT INTO document_group (slug, title) VALUES ($1, $2) RETURNING id",
            "Test Group Slug",
    ...
    #[sqlx::test(migrations = "./migrations")]
   async fn test_update_document_metadata_undefined_values(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
   ...
   #[sqlx::test(migrations = "./migrations")]
   async fn test_update_document_metadata_extreme_values(pool: PgPool) -> Result<(), Box<dyn std::error::Error>> {
       // Create document group
       let group_id = sqlx::query!(
           "INSERT INTO document_group (slug, title) VALUES ($1, $2) RETURNING id",
           "Test Group Slug",
