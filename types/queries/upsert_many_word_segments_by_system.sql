insert into word_segment (gloss_id, word_id, index_in_word, morpheme, role, representation_system_type)
...
on conflict (word_id, index_in_word, representation_system_type)
do update set
