...
| `publication_date`  | `text`    | Date of publication for the edited collection      |
| `editors`           | `text`    | Vector of text for each editor for this collection |
...
| `publication_date` | `text`               | Date of publication for this chapter                                                                                                                                                                                        |
| `authors`          | `text`               | Vector text which holds the authors of this given chapter                                                                                                                                                                   |
